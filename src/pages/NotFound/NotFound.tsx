    ...
    <section className='bg-white dark:bg-gray-900'>
      <div className='mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16'>
        <div className='mx-auto max-w-screen-sm text-center'>
          <h1 className='mb-4 text-7xl font-extrabold tracking-tight text-main-orange lg:text-9xl'>404</h1>
          <p className='mb-4 text-3xl font-bold tracking-tight text-main-orange dark:text-white md:text-4xl'>
            Something's missing.
          </p>
